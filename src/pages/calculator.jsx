 ...
 * @property {'function' | 'derivative' | 'integral'} type - The type of function.
...
export default function CalculatorPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      >
        <div
          className="absolute inset-0" // Inner decorative gradient
          style={{
            background:
        ...
        <div className="relative">
          ...
          >
            <h1 className="text-3xl font-bold text-white mb-2">Advanced Calculator</h1>
            <p className="text-slate-300">Graphing, calculus, and linear algebra tools</p>
          </motion.div>
